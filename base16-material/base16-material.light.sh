...
color_foreground="37/47/4f" # Base 02
color_background="ff/ff/ff" # Base 07
color_cursor="37/47/4f" # Base 02
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  printf $printf_template_custom Pg 37474f # forground
  printf $printf_template_custom Ph ffffff # background
  printf $printf_template_custom Pi 37474f # bold color
  printf $printf_template_custom Pj ecefef # selection color
  printf $printf_template_custom Pk 37474f # selected text color
  printf $printf_template_custom Pl 37474f # cursor
